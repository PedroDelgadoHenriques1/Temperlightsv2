...
- Product folders and files structured are updated: [README](https://github.com/creativetimofficial/material-painel-react/blob/main/README.md)
...
- https://github.com/creativetimofficial/material-painel-react/issues/145 (this was solved since we've changed react-google-maps with simple Google Maps API)
- https://github.com/creativetimofficial/material-painel-react/issues/140 (this was solved since we've changed react-google-maps with simple Google Maps API)
- https://github.com/creativetimofficial/material-painel-react/issues/138 (can be closed since it was help wanted)
- https://github.com/creativetimofficial/material-painel-react/issues/137 (user did not respond)
- https://github.com/creativetimofficial/material-painel-react/issues/133 (fixed it by using `useLocation` from `react-router-dom`)
- https://github.com/creativetimofficial/material-painel-react/issues/16 (please check the following page: https://demos.creative-tim.com/material-painel-react/#/rtl/rtl-page)
...
- https://github.com/creativetimofficial/material-painel-react/issues/121
- https://github.com/creativetimofficial/material-painel-react/issues/98
- https://github.com/creativetimofficial/material-painel-react/pull/99
- https://github.com/creativetimofficial/material-painel-react/pull/65
...
- Renamed `assets/jss/material-painel-react/layouts/dashboardStyle.js` to `assets/jss/material-painel-react/layouts/adminStyle.js`
...
- Solved https://github.com/creativetimofficial/material-painel-react/issues/83
...
- [Added RTL support](https://github.com/creativetimofficial/material-painel-react/issues/16)

### Bug Fixing

- [Added new script for npm](https://github.com/creativetimofficial/material-painel-react/issues/69)
- Changed our buggy routing system, now it should work flawlessly, for more info, please refer to our [live docs here](https://demos.creative-tim.com/material-painel-react/#/documentation/routing-system)
- [https://github.com/creativetimofficial/material-painel-react/issues/67](https://github.com/creativetimofficial/material-painel-react/issues/67)
- [https://github.com/creativetimofficial/material-painel-react/issues/68](https://github.com/creativetimofficial/material-painel-react/issues/68)
- [https://github.com/creativetimofficial/material-painel-react/issues/66](https://github.com/creativetimofficial/material-painel-react/issues/66)
...
- **src/layouts/Admin.jsx** (instead of Painel)
- **src/layouts/RTL.jsx**
- **src/views/RTLPage/RTLPage.jsx**

### Deleted components

- **src/layouts/Painel/Painel.jsx** (renamed to Admin)
- **src/routes/painel.jsx**
...
- `src/assets/jss/material-painel-react/components/tasksStyle.jsx`
- `src/assets/jss/material-painel-react/checkboxAdnRadioStyle.jsx`
- `src/assets/jss/material-painel-react/components/customTabsStyle.jsx`
- `src/assets/jss/material-painel-react/components/snackbarContentStyle.jsx`
...
- Github solved issues:
  - `https://github.com/creativetimofficial/material-painel-react/issues/58`
- Changed the `GridContainer` component

### Major style changes

- `src/assets/jss/material-painel-react/components/footerStyle.jsx`
- `src/assets/jss/material-painel-react/components/headerStyle.jsx`
...
- Added resize event listener for window ([see this issue here](https://github.com/creativetimofficial/ct-material-painel-pro-react/issues/40#issuecomment-406983150))
- Added issues template file
- Github solved issues:
  - https://github.com/creativetimofficial/material-painel-react/issues/49 (dropped `react-popper` in favour of `@material-ui/core/Popper`)
  - https://github.com/creativetimofficial/material-painel-react/issues/47
  - https://github.com/creativetimofficial/material-painel-react/issues/45
  - https://github.com/creativetimofficial/material-painel-react/issues/38
  - https://github.com/creativetimofficial/material-painel-react/issues/37
- Github enhancement issues:
  - https://github.com/creativetimofficial/material-painel-react/issues/47 (read the [./README.md](./README.md) file)

### Major style changes

- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/jss/material-painel-react/views/dashboardStyle.jsx`
  - `src/assets/jss/material-painel-react/components/buttonStyle.jsx`
  - `src/assets/jss/material-painel-react/components/cardFooterStyle.jsx`
  - `src/assets/jss/material-painel-react/components/cardHeaderStyle.jsx`
  - `src/assets/jss/material-painel-react/components/headerLinksStyle.jsx`
  - `src/assets/jss/material-painel-react/components/customTabsStyle.jsx`
- Others
  - `src/assets/jss/material-painel-react/tooltipStyle.jsx`
  - `src/assets/jss/material-painel-react/dropdownStyle.jsx`
...
- Moved the styles of `src/components/` inside `src/assets/jss/material-painel-react/components/`
- Moved the styles of `src/layouts/` inside `src/assets/jss/material-painel-react/layouts/`
- Moved the styles of `src/views/` inside `src/assets/jss/material-painel-react/views/`
...
- Renamed `src/containers/App/App.jsx` to `src/layouts/Painel/Painel.jsx`
- Renamed `src/variables/styles.jsx` to `src/assets/jss/material-painel-react.jsx`
- Moved all the files from `src/variables/styles/` to `src/assets/jss/material-painel-react/`
...
- Added design from Material Painel by Creative Tim
